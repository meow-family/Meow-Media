...
class GetUnreadMessagesUseCase @Inject constructor(
    ...
    suspend operator fun invoke(receiverId: Int): MessagesList {
        return socialRepository.unreadMessages(fetchUserIdUseCase(), receiverId).toMessagesList(fetchUserIdUseCase())
    }
